...
NetworkManagerServer::NetworkManagerServer()
    : mNewPlayerId(1), mNewNetworkId(1), mTimeBetweenStatePackets(0.033f), mClientDisconnectTimeout(3.f)
{
}
...
void NetworkManagerServer::ProcessPacket(ClientProxyPtr inClientProxy, InputMemoryBitStream &inInputStream)
{
    ...
    {
    case kHelloCC:
        // need to resend welcome. to be extra safe we should check the name is
        // the one we expect from this address, otherwise something weird is
        // going on...
                                                     ...
                                                     const SocketAddress &inFromAddress)
{
    ...
    if (packetType == kHelloCC)
    {
        ...
        // it... instead we'll just tell the server directly
