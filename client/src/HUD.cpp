...
HUD::HUD()
    : mScoreBoardOrigin(50.f, 60.f, 0.0f), mBandwidthOrigin(50.f, 10.f, 0.0f), mRoundTripTimeOrigin(50.f, 10.f, 0.0f),
      mScoreOffset(0.f, 50.f, 0.0f), mHealthOffset(1000, 10.f, 0.0f), mHealth(0)
{
    TTF_Init();
    const char *prefix = "/home/erik/prog/cpp/multiplayer/chapter-6/robo-cat-action/res/fonts/Carlito-Regular.TTF";
    mFont = TTF_OpenFont(prefix, 36);
    if (mFont == nullptr)
    {
