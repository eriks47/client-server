...
NetworkManagerClient::NetworkManagerClient() : mState(NCS_Uninitialized), mLastRoundTripTime(0.f)
{
}
...
{
    // copy the mNetworkIdToGameObjectMap so that anything that doesn't get an
    // updated can be destroyed...
